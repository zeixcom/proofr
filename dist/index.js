...
/* unused harmony export GLOBAL_DEFAULTS */
...
/* harmony export (immutable) */ __webpack_exports__["b"] = INSTANCE_DEFAULTS;
...
/* harmony export (immutable) */ __webpack_exports__["c"] = TYPE_MAP;


/** DEFAULT PROOFERS  */
const DEFAULT_PROOFERS = {
  required: value => value !== '' && value !== null && typeof value !== 'undefined',
  ...
  email: value => /[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?/g.test(value),

  phone: value => /^[().+\d -]{1,15}$/g.test(value),

  phoneCHLI: value => /^(0[1-9]\d|(\+|00)(41|423))\d{7,9}/g.test(value),

  number: value => !isNaN(parseFloat(value)) //eslint-disable-line
  ,
  ...
  date: value => __WEBPACK_IMPORTED_MODULE_0_moment___default()(value, proofr.dateFormats).isValid(),
  ...
  checkrange: (value, input, range) => {
    if (input instanceof Array === false) return _this.error('The proofer checkrange only works with radiobuttons or checkboxes');
  ...
  checkmin: (value, input, range) => {
    if (input instanceof Array === false) return _this.error('The proofer checkmin only works with radiobuttons or checkboxes');
  ...
  checkmax: (value, input, range) => {
    if (input instanceof Array === false) return _this.error('The proofer checkmax only works with radiobuttons or checkboxes');
...
/* harmony export (immutable) */ __webpack_exports__["a"] = DEFAULT_PROOFERS;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__extra_global__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__extra_opts__ = __webpack_require__(1);



/** Add the global proofr element to window, so its globally available */
window.proofr = new __WEBPACK_IMPORTED_MODULE_0__extra_global__["a" /* default */]();
...
class Proofr {
  constructor(form, options = {}) {
    ...
    this.options = Object.assign({}, __WEBPACK_IMPORTED_MODULE_1__extra_opts__["b" /* INSTANCE_DEFAULTS */], options);
  ...
  proofField(field, key) {
    ...
    const failedProofs = resultsKey.filter(proofName => !results[proofName]);
...
/* harmony export (immutable) */ __webpack_exports__["default"] = Proofr;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__opts__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lang_en_lang__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lang_de_lang__ = __webpack_require__(125);
...
class GlobalProofr {
  constructor() {
    this.proofers = __WEBPACK_IMPORTED_MODULE_0__opts__["a" /* DEFAULT_PROOFERS */];
    this.typeMap = __WEBPACK_IMPORTED_MODULE_0__opts__["c" /* TYPE_MAP */];

    this.lang = this.getBrowserOrDocLang();
    this.dateFormats = ['YYYY-MM-DD', 'DD.MM.YYYY', 'DD/MM/YYYY', 'DD-MM-YYYY'];

    this.messages = {
      en: __WEBPACK_IMPORTED_MODULE_1__lang_en_lang__["a" /* default */],
      de: __WEBPACK_IMPORTED_MODULE_2__lang_de_lang__["a" /* default */]
    };
  }
  ...
  getLangMessage(title) {
    return typeof this.messages[this.lang][title] !== typeof undefined ? this.messages[this.lang][title] : this.messages[this.lang].default;
  }
  ...
  setDateFormat(format) {
    switch (format) {
      ...
      case 'uk':
      case 'usa':
        this.dateFormats = ['YYYY-MM-DD', 'MM.DD.YYYY', 'MM/DD/YYYY', 'MM-DD-YYYY'];
        break;
      default:
        break;
    }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = GlobalProofr;
...
"use strict";
const messages = {
  required: 'This field is required, please add a value',
  pattern: 'This value seems to be invalid',
  email: 'This is not a valid mail address',
  phone: 'This is not a valid phone number',
  phoneCHLI: 'This is not a valid swiss/liechtenstein phone number',
  number: 'This value is not a number',
  date: 'This is not a valid date',
  length: 'The length of this value should be between %min and %max characters',
  minlength: 'The length of this should be atleast %min characters',
  maxlength: 'The length of this should be atmost %max characters',
...
const messages = {
  ...
  email: 'Die Eingabe ist keine gültige Mail-Adresse',
  phone: 'Die Eingabe ist keine gültige Telefonnummer',
  phoneCHLI: 'Die Eingabe ist keine gültige schweizerische oder liechtensteinische Telefonnummer',
  number: 'Die Eingabe ist keine gültige Nummer',
  date: 'Die Eingabe ist kein gültiges Datum',
  length: 'Die Eingabe sollte %min and %max Zeichen lang sein',
  minlength: 'Die Eingabe sollte mindestens %min Zeichen lang sein',
  maxlength: 'Die Eingabe sollte maximal %max Zeichen lang sein',
  url: 'Die Eingabe ist keine gültige URL',
  range: 'Der Wert sollte zwischen %min und %max sein',
